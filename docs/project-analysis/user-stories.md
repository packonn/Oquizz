...
- Les users stories sont des scénarios de test pour évaluer le fonctionnement de l'application

- Une user story est parfois complétée par la spécification détaillée de la fonctionnalité attendue
